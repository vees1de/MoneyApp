...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	category, err := h.service.Create(r.Context(), principal.UserID, request)
	if err != nil {
		httpx.WriteError(w, err)
		return
	}
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		httpx.WriteError(w, httpx.BadRequest("invalid_category_id", "invalid category id"))
		return
	}
	...
	category, err := h.service.Update(r.Context(), principal.UserID, categoryID, request)
	if err != nil {
		httpx.WriteError(w, err)
		return
	}
...
func (h *Handler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.service.Archive(r.Context(), principal.UserID, categoryID); err != nil {
		httpx.WriteError(w, err)
		return
	}
