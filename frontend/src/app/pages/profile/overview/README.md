...
## Назначение
Профиль пользователя и базовая персональная информация.
...
- Показывает данные сотрудника и организационный контекст.
- Позволяет изменить разрешенные поля профиля.
